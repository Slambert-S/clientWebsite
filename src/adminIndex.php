                ...
                <div class="adminMaxWidth allignSelfFix ">
                    <div class="wrapper">
                        ...
                        <form id="" class="formStyle" action="php/saveIndex.php" method="post">
                            ...
                            <textarea name="textServices" class="formSpacing" id="textServices" rows="5" cols="30"><?php echo $serviceTexte ?></textarea>
                            ...
                            for ($j; $j < $nbElement; $j++) {
                                ...
                                echo '<input type="text" class="formSpacing" id="photoTarif' . $j . '" name="photoG' . $j . '" value="' . $galeriPhoto[$j] . '">';
